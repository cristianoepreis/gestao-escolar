...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'e5dca1d5-1f16-461f-a060-1513b958354a' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('e3bb8361-d6b9-405f-bb41-af203748e8c1');
      cy.get(`[data-cy="name"]`).should('have.value', 'e3bb8361-d6b9-405f-bb41-af203748e8c1');
