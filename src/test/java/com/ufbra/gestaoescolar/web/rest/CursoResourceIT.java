...
import com.ufbra.gestaoescolar.repository.CursoRepository;
import com.ufbra.gestaoescolar.service.dto.CursoDTO;
import com.ufbra.gestaoescolar.service.mapper.CursoMapper;
...
class CursoResourceIT {
    ...
    public static Curso createEntity() {
        return new Curso().nome(DEFAULT_NOME).descricao(DEFAULT_DESCRICAO).duracao(DEFAULT_DURACAO);
    }
    ...
    public static Curso createUpdatedEntity() {
        return new Curso().nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).duracao(UPDATED_DURACAO);
    }
    ...
    @Test
    @Transactional
    void checkDuracaoIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        curso.setDuracao(null);
    ...
    void putExistingCurso() throws Exception {
        ...
        updatedCurso.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).duracao(UPDATED_DURACAO);
    ...
    void partialUpdateCursoWithPatch() throws Exception {
        ...
        partialUpdatedCurso.nome(UPDATED_NOME).duracao(UPDATED_DURACAO);
    ...
    void fullUpdateCursoWithPatch() throws Exception {
        ...
        partialUpdatedCurso.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).duracao(UPDATED_DURACAO);
