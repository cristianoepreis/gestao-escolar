...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../matricula.test-samples';

import { MatriculaService, RestMatricula } from './matricula.service';

const requireRestSample: RestMatricula = {
  ...sampleWithRequiredData,
  dataDeMatricula: sampleWithRequiredData.dataDeMatricula?.format(DATE_FORMAT),
};
