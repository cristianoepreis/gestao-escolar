...
import { AdministradorService, EntityArrayResponseType } from '../service/administrador.service';
...
export class AdministradorComponent implements OnInit {
  ...
  trackId = (item: IAdministrador): number => this.administradorService.getAdministradorIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.administradors = dataFromBody;
  }
